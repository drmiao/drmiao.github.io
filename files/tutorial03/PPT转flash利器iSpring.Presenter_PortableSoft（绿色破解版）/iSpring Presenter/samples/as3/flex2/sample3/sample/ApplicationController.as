...
package sample
{
	...
	import sample.components.DragPanel;
	...
	public class ApplicationController
	{
		...
		private var m_dragPanel:DragPanel;
		
		public function ApplicationController(v:sample3)
		{
			...
			m_dragPanel = v.dragPanel;
			
			initEventHandlers();
			
			loadPresentation(PRESENTATION_URL);
		}		
		...
		private function onPlayerInit(e:PlayerInitEvent):void
		{
			...
			m_dragPanel.title = m_presentationInfo.title;
